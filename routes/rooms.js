...
router.get("/available", protect, authorize('admin', 'manager', 'doctor', 'nurse'), scope('Room'), roomController.getAvailableRooms);
router.get('/:id', protect, authorize('admin', 'manager', 'doctor', 'nurse'), scope('Room'), roomController.getRoomById);
router.put('/:id', protect, authorize('admin', 'manager', 'nurse', 'doctor'), scope('Room'), roomController.updateRoom);
